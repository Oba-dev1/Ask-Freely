    ...
    return (
      <div className="animate-fade-in">
        <div className="flex flex-col items-center justify-center min-h-[400px] gap-5">
          ...
          <p className="text-neutral-500">Loading archived events...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="flex items-start justify-between mb-10 gap-6 flex-wrap">
        <div>
          <h1 className="text-4xl font-bold text-neutral-900 mb-1.5 tracking-tight">Archived Events</h1>
          <p className="text-base text-neutral-500">Events you've archived - restore them anytime</p>
        </div>
      ...
      {events.length > 0 ? (
            ...
            >
              ...
              <div className={`p-7 ${viewMode === 'list' ? 'flex-1 flex flex-col' : ''}`}>
                <div className="flex items-start justify-between gap-4 mb-4 flex-col md:flex-row">
                  ...
                  <span className="px-3.5 py-2 rounded-[10px] text-xs font-bold whitespace-nowrap flex items-center gap-1.5 uppercase tracking-wide shadow-[0_2px_4px_rgba(0,0,0,0.05)] bg-gradient-to-br from-neutral-500/15 to-neutral-600/10 text-neutral-700 border border-neutral-500/20">
                    <i className="fas fa-archive text-xs text-neutral-500"></i> Archived
                  </span>
                </div>
                ...
                {getArchivedDate(event) && (
                  <p className="flex items-center gap-2 text-sm text-neutral-400 -mt-2 mb-4 italic">
                    <i className="fas fa-box text-sm text-neutral-400"></i> Archived on {getArchivedDate(event)}
                  </p>
                )}
        ...
        <div className="flex flex-col items-center justify-center py-16 px-8 text-center bg-white rounded-2xl shadow-[0_1px_3px_rgba(0,0,0,0.06),0_1px_2px_rgba(0,0,0,0.04)] border border-black/[0.04]">
          <i className="fas fa-archive text-6xl text-neutral-300 mb-5 opacity-60"></i>
          <h3 className="text-xl font-bold text-neutral-900 mb-2 tracking-tight">No Archived Events</h3>
          <p className="text-base text-neutral-500 mb-7 max-w-[400px]">Events you archive will appear here</p>
          <button
